...
================================
-fo_trak 
-run_fo_trak.sh (shell script for temporarily setting environment variables and executing 
                 the application)
   -to run the shell script, type
   
       ./run_fo_trak.sh <mcr_directory> <argument_list>
    ...
    /mathworks/home/application/v81, run the shell script as:
       ...
       ./run_fo_trak.sh /mathworks/home/application/v81
       
    If you have MATLAB installed in /mathworks/devel/application/matlab, 
    run the shell script as:
    
       ./run_fo_trak.sh /mathworks/devel/application/matlab
-MCRInstaller.zip
