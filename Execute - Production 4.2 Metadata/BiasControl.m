...
%             config = rsp.value;
            ...
            %set shutter speed 
            shutterSpeed = 0.49823522567749023438;  %ms
            config.camera.properties.shutter.absoluteControl = 1;            
            config.camera.properties.shutter.autoActive = 0;
            config.camera.properties.shutter.absoluteValue = shutterSpeed;
            
            %set brightness
            config.camera.properties.brightness.absoluteControl = 0;
            config.camera.properties.brightness.autoActive = 0;
            config.camera.properties.brightness.absoluteValue = 1.5625;
            
            %set gain
            config.camera.properties.gain.absoluteControl = 0;
            config.camera.properties.gain.autoActive = 0;
            config.camera.properties.gain.absoluteValue = 0;

                        
            %set auto exposure
            config.camera.properties.autoExposure.absoluteControl = 0;
            config.camera.properties.autoExposure.autoActive = 0;
            config.camera.properties.autoExposure.absoluteValue = 1.9168701171875;
            ...
            elseif strcmp(movieFormat, 'ufmf')
                ...
                config.logging.settings.ufmf.boxLength = 15;
            end
