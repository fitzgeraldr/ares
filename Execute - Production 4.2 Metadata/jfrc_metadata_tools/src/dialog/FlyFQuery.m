...
%   If you need help or have comments, send me an email
    ...
    if exist('com.ddtek.jdbc.sequelink.SequeLinkDriver','class')~=8
        error('FlyFQuery:CantFindSequeLinkDriver',...
            'Can''t find java sequelink driver. Expected jar file ''sljc.jar'' to be installed at %s.',jarpath);
    end
